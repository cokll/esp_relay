...
extern uint8_t RELAY_LED_BACKLIGHT_PIN;
...
// TLV 结构 1：LED  2：RELAY  3：BUTTON  4：RELAY LED  5：433  6：PWM1  7：PWM2  8：ROT 9：LED BACKLIGHT 99：结束  IO>50 为反
...
//     },
#else
    // {
    //     "1路开关",     // 1 Channel  (ESP32-C3-01M)
    //     1, 1, 18 + 50, // LED IO
    //     2, 1, 1,      // RELAY IO
    //     3, 1, 10,       // BUTTON IO
    //     4, 1, 9,       // RELAY LED IO
    //     5, 1, 3,      // 433 IO
    //     9, 1, 19,        // LED BACKLIGHT
    ...
    {
        "4路无线开关",       // 3 Channel (ESP32-C3-01M)
        1, 1, 18 + 50,   // LED IO
        2, 4, 31, 32, 33, 34, // RELAY IO 虚拟IO 无继电器
        3, 4, 10, 7, 6, 5,  // BUTTON IO
        4, 4, 9, 8, 4, 3, // RELAY LED IO
        5, 1, 0,        // 433 IO
        9, 1, 19,        // LED BACKLIGHT
    ...
    {
        "5路无线开关",       // 3 Channel (ESP32-C3-01M)
        1, 1, 18 + 50,   // LED IO
        2, 5, 31, 32, 33, 34, 35, // RELAY IO 虚拟IO 无继电器
        3, 5, 10, 7, 6, 5, 2,  // BUTTON IO
        4, 5, 9, 8, 4, 3, 1, // RELAY LED IO
        5, 1, 0,        // 433 IO
        9, 1, 19,        // LED BACKLIGHT
