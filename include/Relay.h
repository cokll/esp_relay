...
#define RELAY_LED_BackLIGHT config.led_backlight*2.55  //定义开关面板Led背光灯PWM取值范围0-255
...
private:
    ...
    // PWM
    uint16_t ledLevel = 0;
    uint16_t ledLight = 255;
    uint16_t ledBackLight = 255;
    bool ledUp = true;
    bool canLed = true;
...
public:
    ...
    String getModuleVersion() { return F("2024.05.31.1000"); }
    String getModuleAuthor() { return F("Cokll"); }
    bool moduleLed();
